function rate = training_ddbs_e2e(Nt,B,fc,f,M,d,h,w_train,focus_loc,SNR_t,SNR_dB,Q,K,lsb_sec,sigma_tau)
...
for idx = 1:K
    ...
    y = abs(sum(y,2)).^2;
    [~,i] = max(y);
    w_serve = ttd_beam_impaired(Nt,B,fc,M,d, focus_loc(i,1,idx), focus_loc(i,2,idx), lsb_sec, sigma_tau);
    t = 0;
    for m = 1:M
